...
export class News extends Component {
  ...
  this.setState(
    ...
    async () => {
      const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=ed884557ba4742bf812b6c7c12db0fee&page=${this.state.page}&pageSize=${this.props.pageSize}`;
